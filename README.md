...
An example for a project based on experimental data collection is [this csv file](metadata/metadata_example.csv). Additionally, other illustration of metadata file based on data obtained from open source database is in [this excel spreadsheet](metadata/metadata_example_2.xlsx)
